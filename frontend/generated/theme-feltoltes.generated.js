...
import stylesCss from 'themes/feltoltes/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_feltoltes_componentCss']) {
    
    document['_vaadintheme_feltoltes_componentCss'] = true;
  }
